...
cpp_pairwise_distances_XYstr <- function(X, Y, str_metric) {
    .Call(`_pmetric_cpp_pairwise_distances_XYstr`, X, Y, str_metric)
}
...
cpp_pairwise_distances_Xstr <- function(X, str_metric) {
    .Call(`_pmetric_cpp_pairwise_distances_Xstr`, X, str_metric)
}
...
cpp_pairwise_distances_XYCall <- function(X, Y, metric) {
    .Call(`_pmetric_cpp_pairwise_distances_XYCall`, X, Y, metric)
}
...
cpp_pairwise_distances_XCall <- function(X, metric) {
    .Call(`_pmetric_cpp_pairwise_distances_XCall`, X, metric)
}
